                        ...
                        <div className="mt-3">
                           ...
                           <div className="flex space-x-5 mt-10">
                                <div className="flex">
                                    ...
                                    <input onChange={e=>{dusername=e.target.value}} type="text" id="website-admin" class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block min-w-0 text-sm border-gray-300 p-2.5" placeholder="username" defaultValue={username}/>
                                </div>
